...
module tb_addressing_modes;
    ...
    initial begin
        ...
        operand2 = 8'h00;
        #10;
        assert (effective_addr == 16'h0201)
        ...
        operand2 = 8'h00;
        #10;
        assert (effective_addr == 16'h0080)
        ...
        operand2 = 8'h00;
        #10;
        assert (effective_addr == 16'h0085)
        ...
        #10;
        assert (effective_addr == 16'h1234)
        ...
        operand2 = 8'h12;
        #10;
        assert (effective_addr == 16'h1239)
        ...
        operand2 = 8'h12;
        #10;
        assert (effective_addr == 16'h1304)

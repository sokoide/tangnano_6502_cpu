...
module top (
    ...
    initial begin
        ...
        test_operand1_data[0] = 8'h55;
        test_operand2_data[0] = 8'h00;  // LDA #$55
        test_opcodes[1] = 8'hA5;
        test_operand1_data[1] = 8'h80;
        test_operand2_data[1] = 8'h00;  // LDA $80
        test_opcodes[2] = 8'hB5;
        test_operand1_data[2] = 8'h80;
        test_operand2_data[2] = 8'h00;  // LDA $80,X
        test_opcodes[3] = 8'hAD;
        test_operand1_data[3] = 8'h34;
        test_operand2_data[3] = 8'h12;  // LDA $1234
        test_opcodes[4] = 8'hBD;
        test_operand1_data[4] = 8'h34;
        test_operand2_data[4] = 8'h12;  // LDA $1234,X
        test_opcodes[5] = 8'hB9;
        test_operand1_data[5] = 8'h34;
        test_operand2_data[5] = 8'h12;  // LDA $1234,Y
        test_opcodes[6] = 8'h85;
        test_operand1_data[6] = 8'h90;
        test_operand2_data[6] = 8'h00;  // STA $90
        test_opcodes[7] = 8'h8D;
        test_operand1_data[7] = 8'h56;
        test_operand2_data[7] = 8'h34;  // STA $3456
        test_opcodes[8] = 8'h69;
        test_operand1_data[8] = 8'h10;
        test_operand2_data[8] = 8'h00;  // ADC #$10
        test_opcodes[9] = 8'h4C;
        test_operand1_data[9] = 8'h00;
        test_operand2_data[9] = 8'h30;  // JMP $3000
        test_opcodes[10] = 8'h10;
        test_operand1_data[10] = 8'h05;
        test_operand2_data[10] = 8'h00;  // BPL +5
        test_opcodes[11] = 8'hD0;
        test_operand1_data[11] = 8'hFB;
        test_operand2_data[11] = 8'h00;  // BNE -5
        test_opcodes[12] = 8'hAA;
        test_operand1_data[12] = 8'h00;
        test_operand2_data[12] = 8'h00;  // TAX
        test_opcodes[13] = 8'hA1;
        test_operand1_data[13] = 8'h20;
        test_operand2_data[13] = 8'h00;  // LDA ($20,X)
        test_opcodes[14] = 8'hB1;
        test_operand1_data[14] = 8'h30;
        test_operand2_data[14] = 8'h00;  // LDA ($30),Y
        test_opcodes[15] = 8'hEA;
        test_operand1_data[15] = 8'h00;
        test_operand2_data[15] = 8'h00;  // NOP
    end

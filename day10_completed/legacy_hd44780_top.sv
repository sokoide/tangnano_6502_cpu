// Legacy (not built): Day 10 HD44780 character LCD system
//
// This file preserves the original Day10 top-level that targeted an HD44780-compatible
// character LCD. The current curriculum uses the 480x272 RGB TFT (same as day99).
//
// To avoid confusion, this module is not referenced by the current Makefile/Gowin projects.

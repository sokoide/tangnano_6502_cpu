...
assign dout[0] = dff_q_0 ? sdpb_inst_0_dout[0] : sdpb_inst_1_dout[0];
assign dout[1] = dff_q_0 ? sdpb_inst_2_dout[1] : sdpb_inst_3_dout[1];
assign dout[2] = dff_q_0 ? sdpb_inst_4_dout[2] : sdpb_inst_5_dout[2];
assign dout[3] = dff_q_0 ? sdpb_inst_6_dout[3] : sdpb_inst_7_dout[3];
assign dout[4] = dff_q_0 ? sdpb_inst_8_dout[4] : sdpb_inst_9_dout[4];
assign dout[5] = dff_q_0 ? sdpb_inst_10_dout[5] : sdpb_inst_11_dout[5];
assign dout[6] = dff_q_0 ? sdpb_inst_12_dout[6] : sdpb_inst_13_dout[6];
assign dout[7] = dff_q_0 ? sdpb_inst_14_dout[7] : sdpb_inst_15_dout[7];

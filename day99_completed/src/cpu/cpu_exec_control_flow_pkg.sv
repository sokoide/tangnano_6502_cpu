...
package cpu_exec_control_flow_pkg;
  ...
  task automatic exec_control_flow(
      ...
      input logic [7:0] dout_r, ref logic [2:0] written_data_bytes, ref logic [7:0] sp,
      ref logic [14:0] ada, ref logic [7:0] din, ref logic cea, ref logic v_cea, ref logic [7:0] ra,
      ref logic flg_c, ref logic flg_z, ref logic flg_i, ref logic flg_d, ref logic flg_b,
      ref logic flg_v, ref logic flg_n, output logic handled);
    handled = 1'b1;
      ...
      8'h6C: begin
        case (fetched_data_bytes)
          ...
          1: begin
            ...
            start_fetch_data((operands[14:0] + 15'd1) & RAMW[14:0], adb, state, fetch_stage,
                             fetch_resume_state);
          end
          2: begin

...
package cpu_exec_store_pkg;
    ...
    task automatic do_store_write(
        input logic [15:0] target_addr, input logic [7:0] data, ref logic [9:0] v_ada,
        ref logic [7:0] v_din, ref logic [14:0] ada, ref logic [7:0] din, ref logic write_to_vram);
        logic [31:0] target32;
    ...
    task automatic exec_store(
        ...
        ref logic [15:0] fetched_data, input logic [7:0] dout_r, ref logic [9:0] v_ada,
        ref logic [7:0] v_din, ref logic v_cea, ref logic [14:0] ada, ref logic [7:0] din,
        ref logic cea, ref logic write_to_vram, ref logic [15:0] pc, ref logic [15:0] pc_plus1,
        ref logic [15:0] pc_plus2, ref logic [15:0] pc_plus3, ref logic [14:0] adb,
        ref cpu_state_e state, ref fetch_stage_e fetch_stage, ref cpu_state_e fetch_resume_state,

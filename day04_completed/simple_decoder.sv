...
module simple_decoder (
    ...
    always_comb begin
        ...
        case (opcode)
            ...
            // ASL instructions
            8'h0A, 8'h06, 8'h16, 8'h0E, 8'h1E: is_shift = 1'b1;

            // LSR instructions
            8'h4A, 8'h46, 8'h56, 8'h4E, 8'h5E: is_shift = 1'b1;

            // ROL instructions
            8'h2A, 8'h26, 8'h36, 8'h2E, 8'h3E: is_shift = 1'b1;

            // ROR instructions
            8'h6A, 8'h66, 8'h76, 8'h6E, 8'h7E: is_shift = 1'b1;

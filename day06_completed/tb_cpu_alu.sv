...
module tb_cpu_alu;
    ...
    initial begin
        ...
        #10;
        assert (result == 8'h80)
        else $error("Test 1 failed: ADD 0x50+0x30");
        assert (negative == 1'b1)
        else $error("Test 1 failed: negative flag should be set");
        assert (zero == 1'b0)
        else $error("Test 1 failed: zero flag should be clear");
        assert (carry_out == 1'b0)
        else $error("Test 1 failed: carry should be clear");
        assert (overflow == 1'b1)
        else $error("Test 1 failed: overflow should be set");
        $display("Test 1 passed: ADD 0x50+0x30 = 0x%02X (N=%b Z=%b C=%b V=%b)", result, negative,
        ...
        #10;
        assert (result == 8'h00)
        else $error("Test 2 failed: ADD 0xFF+0x01");
        assert (zero == 1'b1)
        else $error("Test 2 failed: zero flag should be set");
        assert (carry_out == 1'b1)
        else $error("Test 2 failed: carry should be set");
        $display("Test 2 passed: ADD 0xFF+0x01 = 0x%02X (C=%b Z=%b)", result, carry_out, zero);
        ...
        #10;
        assert (result == 8'h50)
        else $error("Test 3 failed: SUB 0x80-0x30");
        assert (carry_out == 1'b1)
        else $error("Test 3 failed: carry should remain set");
        ...
        #10;
        assert (result == 8'hB0)
        else $error("Test 4 failed: SUB 0x30-0x80");
        assert (carry_out == 1'b0)
        else $error("Test 4 failed: carry should be clear (borrow)");
        ...
        #10;
        assert (result == 8'h00)
        else $error("Test 5 failed: AND 0xF0&0x0F");
        assert (zero == 1'b1)
        else $error("Test 5 failed: zero flag should be set");
        ...
        #10;
        assert (result == 8'hFF)
        else $error("Test 6 failed: OR 0xF0|0x0F");
        assert (negative == 1'b1)
        else $error("Test 6 failed: negative flag should be set");
        ...
        #10;
        assert (result == 8'hFF)
        else $error("Test 7 failed: XOR 0xAA^0x55");
        ...
        #10;
        assert (result == 8'h02)
        else $error("Test 8 failed: ASL 0x81");
        assert (carry_out == 1'b1)
        else $error("Test 8 failed: carry should be set from bit 7");
        ...
        #10;
        assert (result == 8'h40)
        else $error("Test 9 failed: LSR 0x81");
        assert (carry_out == 1'b1)
        else $error("Test 9 failed: carry should be set from bit 0");
        ...
        #10;
        assert (result == 8'h03)
        else $error("Test 10 failed: ROL 0x81 with carry");
        assert (carry_out == 1'b1)
        else $error("Test 10 failed: carry should be set from bit 7");
        ...
        #10;
        assert (result == 8'hC0)
        else $error("Test 11 failed: ROR 0x81 with carry");
        assert (carry_out == 1'b1)
        else $error("Test 11 failed: carry should be set from bit 0");
        ...
        #10;
        assert (result == 8'hFF)
        else $error("Test 12 failed: INC 0xFE");
        assert (carry_out == 1'b0)
        else $error("Test 12 failed: INC should not affect carry");
        ...
        #10;
        assert (result == 8'h00)
        else $error("Test 13 failed: DEC 0x01");
        assert (zero == 1'b1)
        else $error("Test 13 failed: zero flag should be set");
        assert (carry_out == 1'b0)
        else $error("Test 13 failed: DEC should not affect carry");
        ...
        #10;
        assert (result == 8'h00)
        else $error("Test 14 failed: CMP 0x50,0x50");
        assert (zero == 1'b1)
        else $error("Test 14 failed: zero flag should be set for equal");
        assert (carry_out == 1'b1)
        else $error("Test 14 failed: carry should be set for A>=B");

        ...
        if (!rst_n) begin
            ...
            case (vram_write_state)
                ...
                S_WRITE_P_LABEL: begin
                    vram_cea <= 1'b1; vram_ada <= 23; vram_din <= "P";
                ...
                S_WRITE_P1: begin
                    vram_cea <= 1'b1; vram_ada <= 25; vram_din <= to_hex(cpu_debug_p[7:4]);
                    vram_write_state <= S_WRITE_P0;
                end
                S_WRITE_P0: begin
                    vram_cea <= 1'b1; vram_ada <= 26; vram_din <= to_hex(cpu_debug_p[3:0]);
                    vram_write_state <= S_IDLE;
                end
